...
import type { GenreDTO } from "@/lib/api";
            ...
            <Card className="h-full overflow-hidden hover:shadow-md transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className={`p-3 rounded-lg ${genreColors[genre.slug] || "bg-gray-500/10 text-gray-600 border-gray-200 dark:border-gray-800"}`}>
